...
import { Button, Card, Row, Col, Carousel, Rate, Form, Input, DatePicker, Select, Modal, Drawer } from 'antd';
import {
  EnvironmentOutlined,
  PhoneOutlined,
  ClockCircleOutlined,
...
export default function HotelBanquesta() {
  ...
  const handleBooking = (values) => {
    ...
    Modal.success({
      ...
      content: 'Thank you for your interest. Our team will contact you shortly to confirm your reservation.',
    });
    form.resetFields();
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '35px', alignItems: 'center' }}>
            {/* Desktop Menu */}
            <div style={{ display: window.innerWidth > 768 ? 'flex' : 'none', gap: '35px' }}>
              {['home', 'rooms', 'amenities', 'reviews', 'contact'].map((item) => (
                <a
                  ...
                  style={{
                    ...
                    transition: 'all 0.3s ease',
                    borderBottom: activeSection === item ? '2px solid #667eea' : 'none',
                    paddingBottom: '5px'
                  }}
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ margin: 0, opacity: 0.95 }}>Raipur Khadar, Sector 126, Noida, Uttar Pradesh </p>
          </div>
          <div>
