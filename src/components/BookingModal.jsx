...
const BookingModal = ({ bookingModal, setBookingModal, rooms, form, handleBooking }) => {
	const { booking } = businessData;

	return (
		<Modal
			title={<span style={{ fontSize: "24px", fontWeight: "700" }}>{booking.title}</span>}
			open={bookingModal}
		...
		>
			...
			>
				...
				>
					<Input size="large" placeholder={booking.fields.name.placeholder} />
				</Form.Item>
				...
				>
					<Input size="large" placeholder={booking.fields.email.placeholder} />
				</Form.Item>
				...
				>
					<Input size="large" placeholder={booking.fields.phone.placeholder} />
				</Form.Item>
				...
				>
					<Select size="large" placeholder={booking.fields.room.placeholder}>
						{rooms.map((room, idx) => (
				...
				>
					<Select size="large" placeholder={booking.fields.guests.placeholder}>
				...
				{/* Special Requests */}
				<Form.Item label={booking.fields.requests.label} name="requests">
					<TextArea rows={3} placeholder={booking.fields.requests.placeholder} />
				</Form.Item>
